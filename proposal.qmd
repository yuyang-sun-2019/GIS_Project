...
| Task 5: Website Maintanence       | Yuyang, Jia Yiing          |
...
5.  The team then took a bit of time to explore the relevant data and discuss on the area of study.
    ...
    -   However, **Jia Yiing** quickly pointed out we are doing land cover classification and not land use. Philippine is interesting to do but we might be unfamiliar with the area to judge the classes for classification.
