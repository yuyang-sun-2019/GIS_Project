...
Through various tests, we compared both the maximum likelihood and minimum distance and decided to use maximum likelihood as it yields more accuracy as compared to minimum distance.
